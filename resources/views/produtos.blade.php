...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                ...
                <nav class="navbar">
                        ...
                        <ul class="navbar-nav flex-row ms-auto">
                            <li class ='nav-item mt-2 mx-3'>
                                <form action="/produtos" method="GET" style="width: 400px">
        ...
        <div class="searchCategory">
            <strong class="mt-2">Procurar por categoria</strong>
            <form action="/produtos" method="GET" style="300px" class =searchSubmit>
                <div class="mt-0 mx-1">
                        <select class="form-control" id="categoria" name="selectCategoria" style="width: 300px">
